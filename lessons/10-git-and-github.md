# Lesson 10: Git, GitHub, branches, commits, pull requests, and version control for infrastructure
...
## Learning objectives
After this lesson you will be able to explain repositories, branches, commits, remotes, pull requests, reviews, and infrastructure change history, verify your environment, run safe commands, read command output, document findings in `botera.md`, and apply a structured troubleshooting process. You will also improve the continuous Botera learning website project used throughout the course.

## Prerequisites
- **Previous lessons required:** Lessons 1 through 9.
...
**Scenario:** A pipeline fails because an unreviewed configuration change was pushed directly.
...
```bash
mkdir -p ~/botera-course/lesson-10
cd ~/botera-course/lesson-10
printf '# Lesson 10 notes\nStatus: started\n' > botera.md
cat botera.md
```
...
The continuous project is the **Botera DevOps and Network Engineering Course Website**. In this lesson, add or update `botera.md` with a short operational note for lesson 10. The website reads course Markdown from the repository, so documentation becomes part of the product. In real teams, this pattern becomes a runbook or internal developer portal.

## Guided practical lab
**Lab scenario:** You are onboarding to a company and must prove you can perform lesson 10 tasks safely.
...
**Directory structure:** `labs/lesson-10/README.md` plus your local `~/botera-course/lesson-10` workspace.
**Files to create:** `botera.md` and `evidence.txt`.
```bash
mkdir -p ~/botera-course/lesson-10
cd ~/botera-course/lesson-10
printf 'lesson=10\nstatus=lab-started\n' > evidence.txt
printf '# Botera lesson 10 lab\n\nEvidence recorded.\n' > botera.md
cat evidence.txt
cat botera.md
```
...
**Cleanup:** `cd ~ && rm -rf ~/botera-course/lesson-10` if you want to remove the lab.
...
**Scenario:** A teammate needs repeatable notes for lesson 10.
**Goal:** create `~/botera-course/exercise-10/botera.md` with a heading, date, three facts learned, and one open question.
...
**Verification criteria:** `test -s ~/botera-course/exercise-10/botera.md && echo complete`.

## Complete exercise solution
```bash
mkdir -p ~/botera-course/exercise-10
cd ~/botera-course/exercise-10
cat > botera.md <<'EOF'
...
## Homework
Research one term from this lesson, run each listed command twice, create `homework/lesson-10-notes.md`, intentionally cause and fix one safe error, and add one improvement idea for the Botera project. Completion criteria: your note contains command output, one troubleshooting story, and verification steps. Verify with `test -s homework/lesson-10-notes.md`.
...
## Lesson summary
You learned repositories, branches, commits, remotes, pull requests, reviews, and infrastructure change history, practiced commands including `git init`, `git status`, `git add`, `git commit`, `git branch`, created files, verified output, studied common errors, and connected beginner practice to production best practices.

## Connection to the next lesson
This lesson prepares you for **the next course delivery: Bash scripting, web servers, Docker, and CI/CD foundations** by giving you vocabulary, safe command habits, and documentation discipline that the next topic depends on.
