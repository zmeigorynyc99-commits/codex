...
const NETWORKING_TUTORIAL_CONTENT = `# Zero to Hero Networking: Linux, Windows, OpenStack, and Open vSwitch
...
export function seedNetworkingTutorial(db: Database.Database): void {
  ...
  const result = db.prepare(
    ...
    title: 'Zero to Hero Networking: Linux, Windows, OpenStack, and Open vSwitch',
    slug: NETWORKING_TUTORIAL_SLUG,
    summary: 'A comprehensive 60-hour networking roadmap covering fundamentals, Linux and Windows administration, virtualization, OpenStack Neutron, Open vSwitch, security, observability, and troubleshooting.',
    ...
    author: 'botera',
    seo_title: 'Zero to Hero Networking Tutorial: Linux, Windows, OpenStack, OVS',
    seo_description: 'Follow a 60-hour networking tutorial from fundamentals to Linux, Windows, OpenStack Neutron, Open vSwitch, security, packet analysis, and troubleshooting.',
    status: 'published',
    featured: 1,
